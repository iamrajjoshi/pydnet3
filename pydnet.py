...
class Pydnet(nn.Module):
    def __init__(self, conv_dim=64):
        ...
        # Depth Decoder
        self.conv_dec_1 = self.conv_disp_block(16 + 8)
        self.conv_dec_2 = self.conv_disp_block(32 + 8)
        self.conv_dec_3 = self.conv_disp_block(64 + 8)
        self.conv_dec_4 = self.conv_disp_block(96 + 8)
        self.conv_dec_5 = self.conv_disp_block(128 + 8)
